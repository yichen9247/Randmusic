 ...
 <?php
    ...
    if($m == 0) {
      ...
      if($website_debug == 1) {
        ...
        echo "\n  ";
        echo '      <div class="mdui-dialog-title"><i class="mdui-icon material-icons mdui-text-color-blue">info_outline</i> 是否反馈该歌单?</div>';
        echo "\n  ";
        echo '      <div class="mdui-dialog-content">当网易云音乐无法播放时或者是歌单存在不适等，您可以向站长反馈该首歌单。</div>';
        echo "\n  ";
